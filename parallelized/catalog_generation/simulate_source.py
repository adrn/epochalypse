...
"""Simulate one star and print it. For eyeballing a source, not for production.
    ...
    python catalog_generation/simulate_source.py 5484066448309985152
    python catalog_generation/simulate_source.py 5484066448309985152 --population 2_companion
